 ...
 * @author Sheena
 */
public class ApplicationsM extends javax.swing.JFrame {

    /**
     * Creates new form Applications
     */
    public ApplicationsM() {
        initComponents();
        loadApplications();
    }
    
    private JPanel createApplicationCard(int recordId, int clientId, String fname, String lname) {
    ...
    acceptBtn.addActionListener(e -> {
        ...
        acceptBtn.setText("Waiting for Admin");
    ...
    config con = new config();
    String sql = "UPDATE mentor_client SET status = ? WHERE mc_id = ?";
    ...
    private void initComponents() {
        ...
        applicationContainer.setBackground(new java.awt.Color(0, 51, 51));
        applicationContainer.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 25, 25));
        jScrollPane1.setViewportView(applicationContainer);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ApplicationsM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ApplicationsM().setVisible(true);
            }
        });
    }
