 ...
 * @author Sheena
 */
public class LogUpdate extends javax.swing.JFrame {

    /**
     * Creates new form LogUpdate
     */
    int energyID;
    session sess = session.getInstance();
    public LogUpdate(int logs_id, String task, int energy_level, String date) {
        ...
        initComponents();
        this.energyID = logs_id;

    Task.setText(task);
    Energy.setValue(energy_level);
    ...
    private void initComponents() {
        ...
        Udbtn.setBackground(new java.awt.Color(0, 51, 51));
        Udbtn.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED, java.awt.Color.white, java.awt.Color.white, null, null));
        Udbtn.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        Udbtn.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                UdbtnMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                UdbtnMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                UdbtnMouseExited(evt);
            }
        });
        Udbtn.setLayout(null);
        ...
        jPanel2.add(Udbtn, new org.netbeans.lib.awtextra.AbsoluteConstraints(390, 480, 190, 60));
...
PreparedStatement pst = con.prepareStatement(sql);
    ...
    private void UdbtnMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_UdbtnMouseEntered
        Udbtn.setBackground(new Color(0,102,102));
    }//GEN-LAST:event_UdbtnMouseEntered

    private void UdbtnMouseExited(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_UdbtnMouseExited
        Udbtn.setBackground(new Color(0,51,51));
    }//GEN-LAST:event_UdbtnMouseExited
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LogUpdate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JPanel Udbtn;
