 ...
 * @author Sheena
 */
public class EditUProfile extends javax.swing.JFrame {

    /** Creates new form EditUProfile */
...
session sess = session.getInstance();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EditUProfile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EditUProfile().setVisible(true);
            }
        });
    }
