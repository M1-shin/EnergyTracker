 ...
 * @author Sheena
 */
public class Urecords extends javax.swing.JFrame {

    /**
     * Creates new form Urecords
     */
    ...
    public void loadUrecords() {

    config conf = new config();
    int currentUserId = sess.getUserId();

    String query = "SELECT ta.name || ' ' || ta.lname AS client_name, "
    + "el.date, "
    + "AVG(el.energy_level) AS avg_energy_level, "
    + "mi.insight "
    + "FROM energy_log el "
    + "LEFT JOIN tbl_accts ta ON el.u_id = ta.a_id "
    + "LEFT JOIN mentor_insights mi "
    + "ON el.u_id = mi.client_id "
    + "AND DATE(mi.date_created) = DATE(substr(el.date,7,4)||'-'||substr(el.date,1,2)||'-'||substr(el.date,4,2)) "
    + "WHERE el.u_id = " + currentUserId + " "
    + "GROUP BY el.u_id, el.date "
    + "ORDER BY el.date DESC";

    try {

        ResultSet rs = conf.getData(query);
        Urecords.setModel(DbUtils.resultSetToTableModel(rs));
    ...
    private void initComponents() {
        ...
        Urecords = new javax.swing.JTable();
        ...
        Urecords.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane2.setViewportView(Urecords);

        jPanel6.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 30, 860, 510));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Urecords.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTable Urecords;
