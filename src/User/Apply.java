...
public class Apply extends javax.swing.JFrame {
    ...
    private JPanel createMentorCard(int mentorId, String fname, String lname) {
    ...
    try {
        ...
        JOptionPane.showMessageDialog(null, "Error loading mentors: " + e.getMessage());
    }
}
    
    private void sendRequest(int mentorId) {

    config con = new config();
    int clientId = session.getInstance().getUserId();

    String sql = "INSERT INTO mentor_client (mentor_id, client_id, status) VALUES (?, ?, ?)";
    ...
    private javax.swing.JPanel mentorContainer;
