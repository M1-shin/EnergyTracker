...
public class Applications extends javax.swing.JFrame {
    ...
    private JPanel createApplicationCard(int recordId, String mentorName, String clientName) {
    ...
    private void initComponents() {
        ...
        applicationContainer.setBackground(new java.awt.Color(16, 79, 79));
        applicationContainer.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 25, 25));
        jPanel6.add(applicationContainer, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 20, 880, 860));
