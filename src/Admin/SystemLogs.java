...
public class SystemLogs extends javax.swing.JFrame {
    ...
    String sql = "SELECT "
            + "mc.mc_id, "
            + "mc.client_id, "
            + "c.name || ' ' || c.lname AS Client, "
            + "m.name || ' ' || m.lname AS Mentor, "
            ...
            + "ORDER BY mc.approved_date DESC";

    conf.displayData(sql, ClientsTable);
    ...
    if (ClientsTable.getColumnModel().getColumnCount() > 1) {
        ...
        ClientsTable.getColumnModel().getColumn(1).setPreferredWidth(0);
    ...
    private void initComponents() {
        ...
        jPanel6.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 30, 860, 220));

        ChartContainer.setLayout(new java.awt.BorderLayout());
        jPanel6.add(ChartContainer, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 270, 860, 270));
        ...
        jPanel2.add(Acc1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 470, 360, 60));

        Logs.setBackground(new java.awt.Color(16, 79, 79));
        ...
        jPanel2.add(Logs, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 410, 360, 60));
    ...
    private void ClientsTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ClientsTableMouseClicked
        ...
        int clientId = Integer.parseInt(ClientsTable.getValueAt(row, 1).toString());
